...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell.isPlaceholder) {
       // if (_placeholderType == FSCalendarPlaceholderTypeNone)
        ...
        else if (![self isDateInRange:cell.date]) {
...
//    if (cell.dateIsToday && cell.isPlaceholder) {
//        cell.appearance.todayColor = [UIColor clearColor ];
//    }
//    else
    {
        switch (_scope) {
...
//changes dhaval
-(void)removeAllSelecteddate {
    [_selectedDates removeAllObjects];
}

-(void)makeAllSelecteddate:(NSMutableArray *)arrayDate {
    _selectedDates = arrayDate;
}
