...
class MyTribeViewController: UIViewController,UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource {
...
//        
//        if self.UserType == 2 {
//            self.appDelegate.selectedMenuIndex = 3
//        }
//        else if self.UserType == 1{
//            self.appDelegate.selectedMenuIndex = 4
//        }
...
class MytribeCell: UITableViewCell
{
